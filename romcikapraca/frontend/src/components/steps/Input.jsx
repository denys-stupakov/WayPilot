    ...
    <div>
      ...
      {data?.g_expr && data?.h_expr && (
        <div style={{
          ...
          <div style={{
            fontSize: '15px', color: 'var(--color-axis)',
          ...
          <div style={{ marginBottom: '8px' }}>
            <div style={{
              ...
              fontFamily: 'serif', fontSize: '18px', color: 'var(--color-func1)',
            }}>
          ...
          <div>
            <div style={{
              ...
              fontFamily: 'serif', fontSize: '18px', color: 'var(--color-func2)',
            }}>
          ...
          <div style={{
            ...
            borderRadius: '6px', fontSize: '15px', color: 'var(--color-axis)',
